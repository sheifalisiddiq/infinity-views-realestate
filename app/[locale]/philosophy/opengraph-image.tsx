    ...
    (
      ...
      >
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 16 }}>
          ...
          <div style={{ color: '#EDE7D9', fontSize: 76, fontWeight: 300, lineHeight: 1.05, letterSpacing: '-0.02em' }}>
            A different kind of
          </div>
          <div style={{ color: '#EDE7D9', fontSize: 76, fontWeight: 300, lineHeight: 1.05, letterSpacing: '-0.02em', fontStyle: 'italic' }}>
            real estate firm.
          </div>
        </div>
